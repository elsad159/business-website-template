  ...
  return (
    <div className={`flex flex-row p-6 rounded-[20px] ${index !== features.length - 1 ? 'mb-6' : 'mb-0'} feature-card`}>
      ...
      <div className='flex-1 flex flex-col ml-3 w-[100%]'>
        <h4 className='font-poppins font-semibold text-white text-[16px] ss:text-[18px] leading-[22px] ss:leading-[23px] mb-1'>
          {renderTitleWithGradient(title)}
        </h4>
        <p className='font-poppins font-normal text-dimWhite text-[14px] ss:text-[16px] leading-[22px] ss:leading-[24px]'>
          {content}
        </p>
      </div>
    </div>
